...
xtrain_fall.drop(["label"],axis=1)
xtrain_active.drop(["label"],axis=1)
xtrain_asds.drop(["label"],axis=1)


xtest_fall.drop(["label"],axis=1)
xtest_active.drop(["label"],axis=1)
xtest_asds.drop(["label"],axis=1)
